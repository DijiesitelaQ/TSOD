...
def run(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        for si, pred in enumerate(out):
            ...
            bbox_x1,bbox_y1,bbox_x2,bbox_y2 = int(x_min * 0.8),int(y_min * 0.8),int(x_max * 1.2),int(y_max * 1.2)
            ...
            #         print(cc)
            #         count += 1
            # with open('/home/zeta/LuoQiang/data/datasets/data/newdata/labels/'+txtname,'w+') as f:
            #     for j in sublist:
