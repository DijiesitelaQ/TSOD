...
class DetectX(nn.Module):
    ...
    def __init__(self,
                 num_classes,
                 anchors=1,
                 #in_channels=(128, 128, 128, 128, 128, 128), # 原版yolox-s
                 in_channels=(64, 64, 64, 64, 64, 64), # yolox-nano
                 inplace=True,
        ...
        self.iou_loss = IOUloss(reduction="none", loss_type="iou")  ##################默认iou
...
class DetectYoloX(nn.Module):
    ...
    def __init__(self,
        ...
        cls_in_channels = in_channels[0::2]     # 从索引0开始隔一个取一个值，0,2,4...
        reg_in_channels = in_channels[1::2]      # 从索引1开始隔一个取一个值，1,3,5...
        for cls_in_channel, reg_in_channel in zip(cls_in_channels, reg_in_channels):
            cls_pred = nn.Conv2d(
                    in_channels=cls_in_channel,
                    out_channels=self.n_anchors * self.num_classes,
